...
PARTS = [
    ...
    'part_econ', 'part_math', 'part_test', 'part_oyun_elektro', 'part_dataeng', 'part_rust', 'part_java', 'part_korsan', 'part_awesome_lists', 'part_web_medya', 'part_veri_ogr_guv', 'part_final_intake', 'part_mimari_plus', 'part_bulk',
]
